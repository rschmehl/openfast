...
%% defaults for visual studio builds:
    ...
    libDir = '../../../build/bin';
    includeDir = '../../../build/types-files';  % contains "OpenFOAM_Types.h", and "SuperController_Types.h", but not "FAST_Library.h"
    outDir = libDir;
...
mex('-largeArrayDims', ...
    ...
    ['-l' libName], ...
    ['-I' includeDir], ...
    '-I../../../modules-local/openfast-library/src', ... % needed for visual studio builds to find "FAST_Library.h"
    '-outdir', outDir, ...
